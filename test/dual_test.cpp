...
int main() {
  ...
  "DualTest BasicAssertions"_test = [] {
  ...
  // NOLINTNEXTLINE(modernize-use-trailing-return-type)
  "ExpMatTest BasicAssertions"_test = [] {
    ...
    Bd[2, 1] = Dual<double, 2>{
      0.7186280674937524,
      SVector<double, 2>{-0.9224382403836392, -1.117883803285957}};
    ...
    Bd[3, 1] = Dual<double, 2>{
      0.4472989810307133,
      SVector<double, 2>{0.43406926847671146, 0.2778024646943355}};
