...
public:
  ...
  [[nodiscard]] constexpr auto getBasicConstraint(ptrdiff_t var) const
    -> index_t {
  ...
  [[nodiscard]] constexpr auto getBasicVariable(ptrdiff_t constraint) const
    -> index_t {
  ...
  constexpr void rLexCore(PtrMatrix<int64_t> C, PtrVector<int64_t> costs,
                          ptrdiff_t v) {
    invariant(v > 0);
    while (true) {
